...
<head>
    ...
    <title>FSTG - Ajout d'une pièce jointe</title>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            <h3 class="page-title">Ajouter une pièce jointe</h3>
                            <ul class="breadcrumb">
                    ...
                    <div class="card comman-shadow">
                        <div class="card-body">
                            ...
                            <form action="index.php?action=store" method="POST" enctype="multipart/form-data">
                                <input type="hidden" name="id_module" value="<?php if (!empty($id_module)) { echo $id_module; } ?>">
                                <div class="row">
                                    <div class="col-12">
                                        <h5 class="form-title student-info">Informations sur la pièce jointe <span><a href="#"><i class="feather-more-vertical"></i></a></span></h5>
                                    </div>
