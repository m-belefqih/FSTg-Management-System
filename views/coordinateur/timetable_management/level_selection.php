    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col">
                        <h3 class="page-title">Choisissez un niveau pour afficher les horaires</h3>
                        <ul class="breadcrumb">
                        ...
                        <?php foreach ($filieres as $filiere): ?>
                            <div class="card flex-fill bg-white" style="width:fit-content;margin-left:10px">
                                <div class="card-header">
                                    <h5 class="card-title mb-0"><?php echo $filiere['nom'] ?></h5>
                                </div>
                                <div class="card-body">
                                    <p class="card-text">Consultez les emplois du temps pour ce niveau.</p>
                                    <a class="card-link"
                                       href="/FSTg-Management-System/views/coordinateur/timetable_management/index.php?action=list&idFiliere=<?php echo $filiere['id']; ?>&semestre=1">Semestre 1
                                    </a>
                                    <a class="card-link"
                                       href="/FSTg-Management-System/views/coordinateur/timetable_management/index.php?action=list&idFiliere=<?php echo $filiere['id']; ?>&semestre=2">Semestre 2
                                    </a>
                                </div>
                            </div>
                        <?php endforeach; ?>
