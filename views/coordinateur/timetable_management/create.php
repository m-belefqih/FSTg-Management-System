...
<head>
    ...
    <title>FSTG - Ajout d'une séance</title>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            <h3 class="page-title">Ajouter une séance - <?php if (isset($nom_filiere)){ echo $nom_filiere;} ?>  Semestre <?php if (isset($semestre)){ echo $semestre;} ?></h3>
                            <ul class="breadcrumb">
                    ...
                    <div class="card comman-shadow">
                        <div class="card-body">
                            ...
                            <form action="index.php?action=store" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <h5 class="form-title student-info">Informations sur la séance <span><a href="#"><i class="feather-more-vertical"></i></a></span></h5>
                                    </div>
                                    <?php if (isset($modules) && !empty($modules)): ?>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                    <label>Nom du module <span class="login-danger">*</span></label>
                                                    <select class="form-control select" name="id_module" required>
