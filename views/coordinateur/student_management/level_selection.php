        ...
        <div class="page-wrapper">
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col">
                            <h3 class="page-title">Choisissez un niveau pour afficher les étudiants</h3>
                            <ul class="breadcrumb">
                        ...
                        <?php if(isset($filieres)): ?>
                            <?php foreach ($filieres as $filiere): ?>
                                <div class="card flex-fill bg-white" style="width:fit-content;margin-left:10px">
                                    ...
                                    <div class="card-body">
                                        <p class="card-text">Consultez la liste des étudiants inscrits dans ce niveau.</p>
                                        <a class="card-link"
                                           href="/FSTg-Management-System/views/coordinateur/student_management/index.php?action=list&id=<?php echo $filiere['id']; ?>">Voir les étudiants</a>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        <?php endif; ?>
