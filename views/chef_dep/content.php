                                ...
                                <div class="table-responsive lesson">
                                    <table class="table table-center">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="date">
                                                    <b>Algorithmique Avancée et complexité</b>
                                                    <p>Chapitre 3</p>
                                                    <ul class="teacher-date-list">
                                                        <li><i class="fas fa-calendar-alt me-2"></i>June 5, 2024</li>
                                                        <li>|</li>
                                                        <li><i class="fas fa-clock me-2"></i>08:30 - 10:30 am</li>
                                                    </ul>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="date">
                                                    <b>Python pour la science des données</b>
                                                    <p>Chapitre 4</p>
                                                    <ul class="teacher-date-list">
                                                        <li><i class="fas fa-calendar-alt me-2"></i>June 6, 2024</li>
                                                        <li>|</li>
                                                        <li><i class="fas fa-clock me-2"></i>10:30 - 12:30 am</li>
                                                    </ul>
                                                </div>
                                            </td>
                                            <td>
                                    ...
                                    <ul class="activity-feed">
                                        <li class="feed-item d-flex align-items-center">
                                            <div class="dolor-activity">
                                                <span class="feed-text1"><a>Python pour la science des données</a></span>
                                                <ul class="teacher-date-list">
                                                    <li><i class="fas fa-calendar-alt me-2"></i>June 6, 2024</li>
                                                    <li>|</li>
                                        ...
                                        <li class="feed-item d-flex align-items-center">
                                            <div class="dolor-activity">
                                                <span class="feed-text1"><a>Algorithmique Avancée et complexité	</a></span>
                                                <ul class="teacher-date-list">
