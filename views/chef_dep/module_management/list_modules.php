                            ...
                            <div class="page-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto text-end float-end ms-auto download-grp">
                                        <a href="/FSTg-Management-System/controllers/downloadCSV_controller.php?action=modules" class="btn btn-outline-primary me-2"><i class="fas fa-download"></i> Télécharger</a>
